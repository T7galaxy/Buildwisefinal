...
constexpr auto qt_meta_stringdata_CLASSDashboardENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "on_tasksButton_clicked",
    "on_notificationsButton_clicked",
    "on_userManagementButton_clicked"
);
...
Q_CONSTINIT const QMetaObject Dashboard::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDashboardENDCLASS_t,
        ...
        // method 'on_tasksButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_notificationsButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_userManagementButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Dashboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_projectsButton_clicked(); break;
        case 1: _t->on_tasksButton_clicked(); break;
        case 2: _t->on_notificationsButton_clicked(); break;
        case 3: _t->on_userManagementButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
