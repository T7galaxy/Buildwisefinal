...
void CreateUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->userCreated((*reinterpret_cast< std::add_pointer_t<User*>>(_a[1]))); break;
        ...
        {
            using _t = void (CreateUser::*)(User * );
            if (_t _q_method = &CreateUser::userCreated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CreateUser::userCreated(User * _t1)
{
